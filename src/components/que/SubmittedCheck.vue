           ...
           <el-dialog
               ...
               <div style="border: 1px solid #dedede;margin-left: 20px;margin-right: 20px;padding-top: 20px;background-color: #F8F8F8">
                   ...
                   <el-row :gutter="5" style="margin-bottom: 8px"><!--带间隔的布局-->
                       ...
                       <el-col :span="20">
                           <el-tag type="warning" v-if="questionCheckInfo.checkStatus==0">未审核</el-tag>
                           <el-tag  type="success" v-else-if="questionCheckInfo.checkStatus==1">审核通过</el-tag>
                           <el-tag type="danger" v-else-if="questionCheckInfo.checkStatus==2">审核未通过</el-tag>
                       </el-col>
                   </el-row>
                   <el-row :gutter="5" v-if="questionCheckInfo.checkStatus==2" style="margin-bottom: 8px"><!--带间隔的布局-->
                       ...
                       <el-col :span="20">
                           <el-alert
                                   :title="questionCheckInfo.refuseReason"
                                   type="warning"
                                   :closable="false">
               ...
               <span slot="footer" class="dialog-footer">
                       ...
                       <el-button
                               v-if="questionCheckInfo.checkStatus==2"
                               size="small"
                               type="primary"
                               @click="updateQuestion(questionCheckInfo)" plain>修改试题</el-button>
                    <el-button type="primary" @click="dialogVisible2 = false" style="margin-right: 20px">确 定</el-button>
