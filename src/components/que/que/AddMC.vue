<template>
    <div><!--添加多选组件-->
        <el-form
            ...
            <el-row>
                <el-col :span="24" style="margin-top: 0px">
                    <el-form-item label="答案:" prop="answer"  :min="2" >
    ...
    export default {
        ...
        data(){
            return{
                ...
                optionSelectNum:4,
                optionNum:[2,3,4,5,6,7,8,9,10],
                optionChar:['A.',"B.", "C.","D.","E.","F.","G.","H.","I.","J."],
                answerChar2:['A',"B", "C","D","E","F","G","H","I","J"],
                answerChar3:['A',"B", "C","D"],
        ...
        methods: {
            ...
            selectOptionNumChanged(){
                ...
                for(var i=0;i<this.optionSelectNum;i++){
                    this.updateMainQueInfo.options.push({id:i+1,name:''});
            ...
            emptyData(){
                ...
                this.mcMainQueInfo.answer=1;
                this.mcMainQueInfo.analysis='';
                this.scMainQueInfo.options=[];
            }
        }
    }
</script>
