<template>
    ...
    <el-row class="el-row_margin">
        <el-col :span="24" class="bac1">
            ...
            <el-dialog title="章节得分率" :visible.sync="column_value">
                <div id="column" :style="{width: '700px', height: '500px'}" ></div>
                <div style="font-size: 20px">章节得分率是教学反馈的重要指标，考卷中章节得分率高的，在下学期安排教学计划时可以少安排一些时间，考卷中，章节得分率低的，在下学期安排教学计划时可以多安排一些时间。</div>
            </el-dialog>
    ...
    export default {
        ...
        methods:{
            ...
            list_click(row){
                ...
                //向后台发送请求获取数据
                this.postRequest('/teachingFeedback/getScoringRateOfAllChapters?id='+row.id).then(res=>{
                    if(res){
